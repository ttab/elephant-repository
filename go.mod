...
require (
	...
	github.com/ttab/eleconf v0.0.0-20251114083949-dfc5e8e47e13
	github.com/ttab/elephant-api v0.18.3-0.20251117134152-3e4e75e0a016
	github.com/ttab/elephantine v0.22.1-0.20251117112946-8bcbfbff7ed2
