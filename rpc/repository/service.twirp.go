...
func (c *documentsProtobufClient) UpdatePermissions(ctx context.Context, in *UpdatePermissionsRequest) (*UpdatePermissionsResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "elephant.repository")
	ctx = ctxsetters.WithServiceName(ctx, "Documents")
	ctx = ctxsetters.WithMethodName(ctx, "UpdatePermissions")
	caller := c.callUpdatePermissions
	if c.interceptor != nil {
		caller = func(ctx context.Context, req *UpdatePermissionsRequest) (*UpdatePermissionsResponse, error) {
			resp, err := c.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					typedReq, ok := req.(*UpdatePermissionsRequest)
					if !ok {
						return nil, twirp.InternalError("failed type assertion req.(*UpdatePermissionsRequest) when calling interceptor")
					}
					return c.callUpdatePermissions(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*UpdatePermissionsResponse)
				if !ok {
					return nil, twirp.InternalError("failed type assertion resp.(*UpdatePermissionsResponse) when calling interceptor")
				}
				return typedResp, err
			}
			return nil, err
...
func (c *documentsProtobufClient) callUpdatePermissions(ctx context.Context, in *UpdatePermissionsRequest) (*UpdatePermissionsResponse, error) {
...
func (c *documentsJSONClient) UpdatePermissions(ctx context.Context, in *UpdatePermissionsRequest) (*UpdatePermissionsResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "elephant.repository")
	ctx = ctxsetters.WithServiceName(ctx, "Documents")
	ctx = ctxsetters.WithMethodName(ctx, "UpdatePermissions")
	caller := c.callUpdatePermissions
...
func (c *documentsJSONClient) callUpdatePermissions(ctx context.Context, in *UpdatePermissionsRequest) (*UpdatePermissionsResponse, error) {
	out := new(UpdatePermissionsResponse)
...
func (s *documentsServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	case "UpdatePermissions":
		s.serveUpdatePermissions(ctx, resp, req)
		return
	default:
		msg := fmt.Sprintf("no handler for path %q", req.URL.Path)
		s.writeError(ctx, resp, badRouteError(msg, req.Method, req.URL.Path))
...
func (s *documentsServer) serveUpdatePermissions(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveUpdatePermissionsJSON(ctx, resp, req)
	case "application/protobuf":
		s.serveUpdatePermissionsProtobuf(ctx, resp, req)
	default:
		msg := fmt.Sprintf("unexpected Content-Type: %q", req.Header.Get("Content-Type"))
		twerr := badRouteError(msg, req.Method, req.URL.Path)
		s.writeError(ctx, resp, twerr)
...
func (s *documentsServer) serveUpdatePermissionsJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "UpdatePermissions")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
	...
	reqContent := new(UpdatePermissionsRequest)
	unmarshaler := protojson.UnmarshalOptions{DiscardUnknown: true}
	if err = unmarshaler.Unmarshal(rawReqBody, reqContent); err != nil {
		s.handleRequestBodyError(ctx, resp, "the json request could not be decoded", err)
		return
	...
	handler := s.Documents.UpdatePermissions
	if s.interceptor != nil {
		handler = func(ctx context.Context, req *UpdatePermissionsRequest) (*UpdatePermissionsResponse, error) {
			resp, err := s.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					typedReq, ok := req.(*UpdatePermissionsRequest)
					if !ok {
					...
					return s.Documents.UpdatePermissions(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*UpdatePermissionsResponse)
	...
	// Call service method
	var respContent *UpdatePermissionsResponse
	func() {
		defer ensurePanicResponses(ctx, resp, s.hooks)
		respContent, err = handler(ctx, reqContent)
	}()
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *UpdatePermissionsResponse and nil error while calling UpdatePermissions. nil responses are not supported"))
		return
	}
...
func (s *documentsServer) serveUpdatePermissionsProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "UpdatePermissions")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
var twirpFileDescriptor0 = []byte{
	...
	,
}
