...
var file_rpc_repository_service_proto_rawDesc = []byte{
	...
	0x6f, 0x72, 0x79, 0x22, 0x17, 0x0a, 0x15, 0x47, 0x65, 0x74, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73,
...
var file_rpc_repository_service_proto_msgTypes = make([]protoimpl.MessageInfo, 52)
var file_rpc_repository_service_proto_goTypes = []interface{}{
	(*GetStatusRulesRequest)(nil),       // 0: elephant.repository.GetStatusRulesRequest
	(*GetStatusRulesResponse)(nil),      // 1: elephant.repository.GetStatusRulesResponse
	(*GetStatusesRequest)(nil),          // 2: elephant.repository.GetStatusesRequest
	(*WorkflowStatus)(nil),              // 3: elephant.repository.WorkflowStatus
	(*GetStatusesResponse)(nil),         // 4: elephant.repository.GetStatusesResponse
	(*UpdateStatusRequest)(nil),         // 5: elephant.repository.UpdateStatusRequest
	(*UpdateStatusResponse)(nil),        // 6: elephant.repository.UpdateStatusResponse
	(*CreateStatusRuleRequest)(nil),     // 7: elephant.repository.CreateStatusRuleRequest
	(*StatusRule)(nil),                  // 8: elephant.repository.StatusRule
	(*CreateStatusRuleResponse)(nil),    // 9: elephant.repository.CreateStatusRuleResponse
	(*DeleteStatusRuleRequest)(nil),     // 10: elephant.repository.DeleteStatusRuleRequest
	(*DeleteStatusRuleResponse)(nil),    // 11: elephant.repository.DeleteStatusRuleResponse
	(*GetDocumentRequest)(nil),          // 12: elephant.repository.GetDocumentRequest
	(*GetDocumentResponse)(nil),         // 13: elephant.repository.GetDocumentResponse
	(*GetHistoryRequest)(nil),           // 14: elephant.repository.GetHistoryRequest
	(*GetHistoryResponse)(nil),          // 15: elephant.repository.GetHistoryResponse
	(*DocumentVersion)(nil),             // 16: elephant.repository.DocumentVersion
	(*UpdateRequest)(nil),               // 17: elephant.repository.UpdateRequest
	(*ImportDirective)(nil),             // 18: elephant.repository.ImportDirective
	(*UpdateResponse)(nil),              // 19: elephant.repository.UpdateResponse
	(*ValidateRequest)(nil),             // 20: elephant.repository.ValidateRequest
	(*ValidateResponse)(nil),            // 21: elephant.repository.ValidateResponse
	(*ValidationResult)(nil),            // 22: elephant.repository.ValidationResult
	(*EntityRef)(nil),                   // 23: elephant.repository.EntityRef
	(*StatusUpdate)(nil),                // 24: elephant.repository.StatusUpdate
	(*UpdatePermissionsRequest)(nil),    // 25: elephant.repository.UpdatePermissionsRequest
	(*UpdatePermissionsResponse)(nil),   // 26: elephant.repository.UpdatePermissionsResponse
	(*DeleteDocumentRequest)(nil),       // 27: elephant.repository.DeleteDocumentRequest
	(*DeleteDocumentResponse)(nil),      // 28: elephant.repository.DeleteDocumentResponse
	(*GetMetaRequest)(nil),              // 29: elephant.repository.GetMetaRequest
	(*GetMetaResponse)(nil),             // 30: elephant.repository.GetMetaResponse
	(*DocumentMeta)(nil),                // 31: elephant.repository.DocumentMeta
	(*Status)(nil),                      // 32: elephant.repository.Status
	(*ACLEntry)(nil),                    // 33: elephant.repository.ACLEntry
	(*Document)(nil),                    // 34: elephant.repository.Document
	(*Block)(nil),                       // 35: elephant.repository.Block
	(*RegisterSchemaRequest)(nil),       // 36: elephant.repository.RegisterSchemaRequest
	(*RegisterSchemaResponse)(nil),      // 37: elephant.repository.RegisterSchemaResponse
	(*SetActiveSchemaRequest)(nil),      // 38: elephant.repository.SetActiveSchemaRequest
	(*SetActiveSchemaResponse)(nil),     // 39: elephant.repository.SetActiveSchemaResponse
	(*GetSchemaRequest)(nil),            // 40: elephant.repository.GetSchemaRequest
	(*GetSchemaResponse)(nil),           // 41: elephant.repository.GetSchemaResponse
	(*GetAllActiveSchemasRequest)(nil),  // 42: elephant.repository.GetAllActiveSchemasRequest
	(*GetAllActiveSchemasResponse)(nil), // 43: elephant.repository.GetAllActiveSchemasResponse
	(*Schema)(nil),                      // 44: elephant.repository.Schema
	nil,                                 // 45: elephant.repository.DocumentVersion.MetaEntry
	nil,                                 // 46: elephant.repository.UpdateRequest.MetaEntry
	nil,                                 // 47: elephant.repository.StatusUpdate.MetaEntry
	nil,                                 // 48: elephant.repository.DeleteDocumentRequest.MetaEntry
	nil,                                 // 49: elephant.repository.DocumentMeta.HeadsEntry
	nil,                                 // 50: elephant.repository.Status.MetaEntry
	nil,                                 // 51: elephant.repository.Block.DataEntry
}
var file_rpc_repository_service_proto_depIdxs = []int32{
	8,  // 0: elephant.repository.GetStatusRulesResponse.rules:type_name -> elephant.repository.StatusRule
	3,  // 1: elephant.repository.GetStatusesResponse.statuses:type_name -> elephant.repository.WorkflowStatus
	8,  // 2: elephant.repository.CreateStatusRuleRequest.rule:type_name -> elephant.repository.StatusRule
	34, // 3: elephant.repository.GetDocumentResponse.document:type_name -> elephant.repository.Document
	16, // 4: elephant.repository.GetHistoryResponse.versions:type_name -> elephant.repository.DocumentVersion
	45, // 5: elephant.repository.DocumentVersion.meta:type_name -> elephant.repository.DocumentVersion.MetaEntry
	34, // 6: elephant.repository.UpdateRequest.document:type_name -> elephant.repository.Document
	46, // 7: elephant.repository.UpdateRequest.meta:type_name -> elephant.repository.UpdateRequest.MetaEntry
	24, // 8: elephant.repository.UpdateRequest.status:type_name -> elephant.repository.StatusUpdate
	33, // 9: elephant.repository.UpdateRequest.acl:type_name -> elephant.repository.ACLEntry
	18, // 10: elephant.repository.UpdateRequest.import_directive:type_name -> elephant.repository.ImportDirective
	34, // 11: elephant.repository.ValidateRequest.document:type_name -> elephant.repository.Document
	22, // 12: elephant.repository.ValidateResponse.errors:type_name -> elephant.repository.ValidationResult
	23, // 13: elephant.repository.ValidationResult.entity:type_name -> elephant.repository.EntityRef
	47, // 14: elephant.repository.StatusUpdate.meta:type_name -> elephant.repository.StatusUpdate.MetaEntry
	33, // 15: elephant.repository.UpdatePermissionsRequest.list:type_name -> elephant.repository.ACLEntry
	48, // 16: elephant.repository.DeleteDocumentRequest.meta:type_name -> elephant.repository.DeleteDocumentRequest.MetaEntry
	31, // 17: elephant.repository.GetMetaResponse.meta:type_name -> elephant.repository.DocumentMeta
	49, // 18: elephant.repository.DocumentMeta.heads:type_name -> elephant.repository.DocumentMeta.HeadsEntry
	33, // 19: elephant.repository.DocumentMeta.acl:type_name -> elephant.repository.ACLEntry
	50, // 20: elephant.repository.Status.meta:type_name -> elephant.repository.Status.MetaEntry
	35, // 21: elephant.repository.Document.content:type_name -> elephant.repository.Block
	35, // 22: elephant.repository.Document.meta:type_name -> elephant.repository.Block
	35, // 23: elephant.repository.Document.links:type_name -> elephant.repository.Block
	51, // 24: elephant.repository.Block.data:type_name -> elephant.repository.Block.DataEntry
	35, // 25: elephant.repository.Block.links:type_name -> elephant.repository.Block
	35, // 26: elephant.repository.Block.content:type_name -> elephant.repository.Block
	35, // 27: elephant.repository.Block.meta:type_name -> elephant.repository.Block
	44, // 28: elephant.repository.RegisterSchemaRequest.schema:type_name -> elephant.repository.Schema
	44, // 29: elephant.repository.GetAllActiveSchemasResponse.schemas:type_name -> elephant.repository.Schema
	32, // 30: elephant.repository.DocumentMeta.HeadsEntry.value:type_name -> elephant.repository.Status
	12, // 31: elephant.repository.Documents.Get:input_type -> elephant.repository.GetDocumentRequest
	14, // 32: elephant.repository.Documents.GetHistory:input_type -> elephant.repository.GetHistoryRequest
	17, // 33: elephant.repository.Documents.Update:input_type -> elephant.repository.UpdateRequest
	20, // 34: elephant.repository.Documents.Validate:input_type -> elephant.repository.ValidateRequest
	27, // 35: elephant.repository.Documents.Delete:input_type -> elephant.repository.DeleteDocumentRequest
	29, // 36: elephant.repository.Documents.GetMeta:input_type -> elephant.repository.GetMetaRequest
	36, // 37: elephant.repository.Schemas.Register:input_type -> elephant.repository.RegisterSchemaRequest
	38, // 38: elephant.repository.Schemas.SetActive:input_type -> elephant.repository.SetActiveSchemaRequest
	40, // 39: elephant.repository.Schemas.Get:input_type -> elephant.repository.GetSchemaRequest
	42, // 40: elephant.repository.Schemas.GetAllActive:input_type -> elephant.repository.GetAllActiveSchemasRequest
	5,  // 41: elephant.repository.Workflows.UpdateStatus:input_type -> elephant.repository.UpdateStatusRequest
	2,  // 42: elephant.repository.Workflows.GetStatuses:input_type -> elephant.repository.GetStatusesRequest
	7,  // 43: elephant.repository.Workflows.CreateStatusRule:input_type -> elephant.repository.CreateStatusRuleRequest
	10, // 44: elephant.repository.Workflows.DeleteStatusRule:input_type -> elephant.repository.DeleteStatusRuleRequest
	0,  // 45: elephant.repository.Workflows.GetStatusRules:input_type -> elephant.repository.GetStatusRulesRequest
	13, // 46: elephant.repository.Documents.Get:output_type -> elephant.repository.GetDocumentResponse
	15, // 47: elephant.repository.Documents.GetHistory:output_type -> elephant.repository.GetHistoryResponse
	19, // 48: elephant.repository.Documents.Update:output_type -> elephant.repository.UpdateResponse
	21, // 49: elephant.repository.Documents.Validate:output_type -> elephant.repository.ValidateResponse
	28, // 50: elephant.repository.Documents.Delete:output_type -> elephant.repository.DeleteDocumentResponse
	30, // 51: elephant.repository.Documents.GetMeta:output_type -> elephant.repository.GetMetaResponse
	37, // 52: elephant.repository.Schemas.Register:output_type -> elephant.repository.RegisterSchemaResponse
	39, // 53: elephant.repository.Schemas.SetActive:output_type -> elephant.repository.SetActiveSchemaResponse
	41, // 54: elephant.repository.Schemas.Get:output_type -> elephant.repository.GetSchemaResponse
	43, // 55: elephant.repository.Schemas.GetAllActive:output_type -> elephant.repository.GetAllActiveSchemasResponse
	6,  // 56: elephant.repository.Workflows.UpdateStatus:output_type -> elephant.repository.UpdateStatusResponse
	4,  // 57: elephant.repository.Workflows.GetStatuses:output_type -> elephant.repository.GetStatusesResponse
	9,  // 58: elephant.repository.Workflows.CreateStatusRule:output_type -> elephant.repository.CreateStatusRuleResponse
	11, // 59: elephant.repository.Workflows.DeleteStatusRule:output_type -> elephant.repository.DeleteStatusRuleResponse
	1,  // 60: elephant.repository.Workflows.GetStatusRules:output_type -> elephant.repository.GetStatusRulesResponse
