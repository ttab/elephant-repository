...
type GetActiveSchemasRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *GetActiveSchemasRequest) Reset() {
	*x = GetActiveSchemasRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetActiveSchemasRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetActiveSchemasRequest) ProtoMessage() {}

func (x *GetActiveSchemasRequest) ProtoReflect() protoreflect.Message {
	mi := &file_rpc_repository_service_proto_msgTypes[30]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetActiveSchemasRequest.ProtoReflect.Descriptor instead.
func (*GetActiveSchemasRequest) Descriptor() ([]byte, []int) {
	return file_rpc_repository_service_proto_rawDescGZIP(), []int{30}
}

type GetActiveSchemasResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetActiveSchemasResponse) Reset() {
	*x = GetActiveSchemasResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetActiveSchemasResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetActiveSchemasResponse) ProtoMessage() {}

func (x *GetActiveSchemasResponse) ProtoReflect() protoreflect.Message {
	mi := &file_rpc_repository_service_proto_msgTypes[31]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetActiveSchemasResponse.ProtoReflect.Descriptor instead.
func (*GetActiveSchemasResponse) Descriptor() ([]byte, []int) {
	return file_rpc_repository_service_proto_rawDescGZIP(), []int{31}
}

func (x *GetActiveSchemasResponse) GetSchemas() []*Schema {
	if x != nil {
		return x.Schemas
	}
	return nil
...
var file_rpc_repository_service_proto_rawDesc = []byte{
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x73, 0x70, 0x65, 0x63, 0x22, 0x19, 0x0a, 0x17,
	0x47, 0x65, 0x74, 0x41, 0x63, 0x74, 0x69, 0x76, 0x65, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x73,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x51, 0x0a, 0x18, 0x47, 0x65, 0x74, 0x41, 0x63,
	...
	0x52, 0x04, 0x73, 0x70, 0x65, 0x63, 0x32, 0xcf, 0x07, 0x0a, 0x09, 0x44, 0x6f, 0x63, 0x75, 0x6d,
	...
	0x73, 0x65, 0x12, 0x69, 0x0a, 0x0e, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x53, 0x63,
	0x68, 0x65, 0x6d, 0x61, 0x12, 0x2a, 0x2e, 0x65, 0x6c, 0x65, 0x70, 0x68, 0x61, 0x6e, 0x74, 0x2e,
	...
	0x63, 0x68, 0x65, 0x6d, 0x61, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x6c, 0x0a,
	0x0f, 0x53, 0x65, 0x74, 0x41, 0x63, 0x74, 0x69, 0x76, 0x65, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61,
	...
	0x65, 0x6d, 0x61, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x5a, 0x0a, 0x09, 0x47,
	0x65, 0x74, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x12, 0x25, 0x2e, 0x65, 0x6c, 0x65, 0x70, 0x68,
	...
	,
}
...
var file_rpc_repository_service_proto_goTypes = []interface{}{
	...
	(*GetActiveSchemasRequest)(nil),   // 30: elephant.repository.GetActiveSchemasRequest
	(*GetActiveSchemasResponse)(nil),  // 31: elephant.repository.GetActiveSchemasResponse
...
var file_rpc_repository_service_proto_depIdxs = []int32{
	...
	32, // 26: elephant.repository.GetActiveSchemasResponse.schemas:type_name -> elephant.repository.Schema
	...
	24, // 34: elephant.repository.Documents.RegisterSchema:input_type -> elephant.repository.RegisterSchemaRequest
	26, // 35: elephant.repository.Documents.SetActiveSchema:input_type -> elephant.repository.SetActiveSchemaRequest
	28, // 36: elephant.repository.Documents.GetSchema:input_type -> elephant.repository.GetSchemaRequest
	30, // 37: elephant.repository.Documents.GetActiveSchemas:input_type -> elephant.repository.GetActiveSchemasRequest
	...
	25, // 44: elephant.repository.Documents.RegisterSchema:output_type -> elephant.repository.RegisterSchemaResponse
	27, // 45: elephant.repository.Documents.SetActiveSchema:output_type -> elephant.repository.SetActiveSchemaResponse
	29, // 46: elephant.repository.Documents.GetSchema:output_type -> elephant.repository.GetSchemaResponse
	31, // 47: elephant.repository.Documents.GetActiveSchemas:output_type -> elephant.repository.GetActiveSchemasResponse
...
func file_rpc_repository_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_rpc_repository_service_proto_msgTypes[30].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetActiveSchemasRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_rpc_repository_service_proto_msgTypes[31].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetActiveSchemasResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
